...
ALERT_FILE = 'data/af_women_alerts'
...
if __name__ == '__main__':
    ...
    AppendAlertToFile('<h2>' + promo['AF'] + '</h2>', ALERT_FILE)
    
    new_item_checker = AFWhatsNew.AFWhatsNew(items_old, items_new)
    new_item_index = new_item_checker.WhatsNew(brands=['AF'], genders=['WOMEN'], discount=50)
